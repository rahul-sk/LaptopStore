...
namespace LaptopStore.Migrations.ApplicationDB
{
    ...
    [Migration("20211106103945_OrdersModelAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaptopStore.Models.Orders", b =>
                {
                    b.HasOne("LaptopStore.Models.Customer", "CustomerEnt")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LaptopStore.Models.Laptop", "LaptopEnt")
                        .WithMany()
                        .HasForeignKey("LaptopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CustomerEnt");

                    b.Navigation("LaptopEnt");
                });
